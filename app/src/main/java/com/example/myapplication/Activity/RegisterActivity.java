...
public class RegisterActivity extends BasicActivity {
    EditText username, email, password, uni, number;
    Button btn_register;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String txt_uni = uni.getText().toString();
                String txt_number = number.getText().toString();

                if (TextUtils.isEmpty(txt_username) || TextUtils.isEmpty(txt_email) || TextUtils.isEmpty(txt_password)
                        || TextUtils.isEmpty(txt_uni) || TextUtils.isEmpty(txt_number)){
                    ...
                    register(txt_username, txt_email, txt_password, txt_uni, txt_number);
                }
            }
        });
    }

    private void register(String username, String email, String password, String uni, String number){
